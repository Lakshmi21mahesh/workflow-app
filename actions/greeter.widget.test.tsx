...
import GreeterWidget from './greeter.widget';

enableFetchMocks();

describe('GreeterWidget', () => {
  beforeEach(() => {
  ...
  it('should render a widget with values', async () => {
    ...
    fetchMock.mockIf(
      ...
      JSON.stringify({
        items: [
          {
            objectId: 'greeter-connection-object-id',
    ...
    render(
      <GreeterWidget 
        value={{ name: 'Mark', connectionId: 'greeter-connection-object-id' }} 
